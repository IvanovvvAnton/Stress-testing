...
2. [Testing objects](#-testing-objects)
   - [RFID Authentication module](#-rfid-authentication-module)
   - [Biometric authentication module](#-biometric-authentication-module)
   - [Web interface for registering new users](#-web-interface-for-registering-new-users)
   - [Dashboard](#-dashboard)
3. [Testing Tool](#-testing-tool)
   - [Apache JMeter](#-the-rationale-for-choosing-apache-jmeter)
   - [JMeter Configuration](#-jmeter-configuration)
   - [The elements of the Test Plan used](#-the-elements-of-the-test-plan-used)
4. [Description of load scenarios](#-description-of-load-scenarios)
   - [Scenario for the RFID authentication module](#-scenario-for-the-rfid-authentication-module)
   - [Script for the biometric authentication module](#script-for-the-biometric-authentication-module)
   - [Script for the page for adding a new user to the database](#tes-script-for-the-page-for-adding-a-new-user-to-the-database)
   - [Dashboard script](#-dashboard-script)
5. [Load testing results](#-load-testing-results)
   - [Results for the RFID authentication module](#-results-for-the-rfid-authentication-module)
   - [Results for the biometric authentication module](#-results-for-the-biometric-authentication-module)
   - [Results for the page for adding users to the database](#-results-for-the-page-for-adding-users-to-the-database)
   - [Results for the dashboard](#-results-for-the-dashboard)
   - [General conclusion based on the test results](#-general-conclusion-based-on-the-test-results)
6. [Risks and Assumptions](#%EF%B8%8F-risks-and-assumptions)
7. [Conclusions Based on Load Testing](#-conclusions-based-on-load-testing)
8. [Authors](#authors)
